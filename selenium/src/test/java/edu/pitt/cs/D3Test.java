...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    vars.put("href", "http://localhost:8080/reset");
  ...
  public void tEST3CATALOG() {
    ...
    driver.findElement(By.xpath("//a[contains(text(),\'Catalog\')]")).click();
    {
      ...
      vars.put("alt", attribute);
    }
    assertEquals(vars.get("alt").toString(), "Old Deuteronomy");
  }
   @Test
  public void tEST4LISTING() {
    ...
    vars.put("third", driver.findElement(By.xpath("//div/ul/li[3]")).getText());
...
@Test
  ...
  public void tEST9FEED() {
    ...
    driver.findElement(By.xpath("//button[contains(.,\'Feed\')]")).click();
    {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id=\'feedResult\' and text()=\'Nom, nom, nom.\']")));
    }
  ...
  public void tEST11GREETACATWITHNAME() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(1));
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id=\'greeting\']")));
    }
